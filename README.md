...
def prepare_plaintext(plain_text):
    ...
    while i < len(plain_text):
        if i + 1 < len(plain_text) and plain_text[i] == plain_text[i + 1]:
            ...
            i += 2
    if len(prepared_text) > 0 and len(prepared_text[-1]) == 1:  
...
## OUTPUT :-
![image](https://github.com/user-attachments/assets/f3cfd048-8782-48f2-b432-e21f0a9b297c)
